...
set leffile=${HOME}/pdk/share/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lef/sky130_fd_sc_hd.lef

# The SPICE netlist containing subcell definitions for all the standard cells
set spicefile=${HOME}/pdk/share/pdk/sky130A/libs.ref/sky130_fd_sc_hd/spice/sky130_fd_sc_hd.spice

# The liberty format file containing standard cell timing and function information
set libertyfile=${HOME}/pdk/share/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ff_n40C_1v95.lib
...
set techleffile=${HOME}/pdk/share/pdk/sky130A/libs.ref/sky130_fd_sc_hd/techlef/sky130_fd_sc_hd__nom.tlef
...
set gdsfile=${HOME}/pdk/share/pdk/sky130A/libs.ref/sky130_fd_sc_hd/gds/sky130_fd_sc_hd.gds	;# GDS database of standard cells
set verilogfile=${HOME}/pdk/share/pdk/sky130A/libs.ref/sky130_fd_sc_hd/verilog/sky130_fd_sc_hd.v	;# Verilog models of standard cells
